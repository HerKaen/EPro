...
class LendingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lending" do
    assert_difference('Lending.count') do
      post lendings_url, params: { lending: { book: @lending.book, lending_date: @lending.lending_date, return_date: @lending.return_date, user: @lending.user } }
    end
  ...
  test "should update lending" do
    patch lending_url(@lending), params: { lending: { book: @lending.book, lending_date: @lending.lending_date, return_date: @lending.return_date, user: @lending.user } }
