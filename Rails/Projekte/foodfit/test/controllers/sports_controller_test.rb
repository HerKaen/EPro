...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { einheit: @sport.einheit, kalorien: @sport.kalorien, name: @sport.name } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { einheit: @sport.einheit, kalorien: @sport.kalorien, name: @sport.name } }
