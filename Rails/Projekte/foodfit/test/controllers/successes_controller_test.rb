...
class SuccessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create success" do
    assert_difference('Success.count') do
      post successes_url, params: { success: { body_id: @success.body_id, user_id: @success.user_id } }
    end
  ...
  test "should update success" do
    patch success_url(@success), params: { success: { body_id: @success.body_id, user_id: @success.user_id } }
