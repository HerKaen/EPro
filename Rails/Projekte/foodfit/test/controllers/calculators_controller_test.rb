...
class CalculatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculator" do
    assert_difference('Calculator.count') do
      post calculators_url, params: { calculator: { Body_id: @calculator.Body_id, User_id: @calculator.User_id } }
    end
  ...
  test "should update calculator" do
    patch calculator_url(@calculator), params: { calculator: { Body_id: @calculator.Body_id, User_id: @calculator.User_id } }
